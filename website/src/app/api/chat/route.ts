export async function POST(req: Request) {
  try {
    ...
    if (lastMessage.toLowerCase().includes('project')) {
      ...
      response += "Max is currently available for new opportunities! You can reach him at **maxxiongnj@gmail.com** or connect with him on **GitHub** (github.com/maxx06), **LinkedIn** (linkedin.com/in/mx6/), or check out his research on **Google Scholar**. He's passionate about AI research, full-stack development, and solving real-world problems."
